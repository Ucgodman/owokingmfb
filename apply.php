                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav> 
                                        <ul id="navigation">  
                                            ...
                                            <li class="active"><a href="apply.php">Loan</a></li>
                            ...
                            <form action="#">
                                <div class="row">
                                   ...
                                   <!-- Nice Select -->
                                       ...
                                       <div class="single-form">
                                            ...
                                            <div class="select-option mb-10">
                                                <select name="select" id="select1">
                                                    ...
                                                    <option value="">Personal Need</option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="single-form">
                                            <label>* IDENTIFICATION eg. NIMS, Driver License, Voter Card</label>
                                            <div class="select-option mb-10">
                                                <select name="select" id="select1">
                                                    <option value="">NIMS</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="single-form">
                                             ...
                                             <input type="text" name="" placeholder="IDENTIFICATION NUMBER">
                                        </div>
                                     </div>
									 <!-- Phone Number -->
                                    <div class="col-lg-6">
